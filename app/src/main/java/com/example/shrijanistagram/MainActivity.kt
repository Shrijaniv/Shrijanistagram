    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.Send).setOnClickListener {
            ...
            if(photoFile != null){
                ...
                Toast.makeText(this, "Post failed to send, add a picture", Toast.LENGTH_SHORT).show()
            }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                val ivPreview: ImageView = findViewById(R.id.Image)
    ...
    fun submitPost(description: String, User: ParseUser, Image: File){
        ...
        post.saveInBackground{ exception ->
            if (exception != null){
                ...
                findViewById<ImageView>(R.id.Image).setImageResource(0)
            }
        }
